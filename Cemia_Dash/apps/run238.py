            ...
            dbc.Row([
                dbc.Row([
                    dbc.Col([
                        ...
                        html.P([f"In {runid}, a total of ", html.B(total_samples), " samples from ",html.B("Kilifi, and Kiambu "),\
                ...
                dbc.Row([
                    ...
                    dbc.Col([ #fig_n_prop
                            ...
                            html.P([f"This run was dominated by the ", html.B("GE.1 (47%). "),"which was first seen on mid May 23. ",\
                                html.B("FY.4 "),'still observed at',
                                html.B(" 28%"),                             
                            ],style = style_text),
