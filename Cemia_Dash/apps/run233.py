...
complete_data = pd.read_table(DATA_PATH.joinpath("run233/complete_data.txt"),index_col = "sample_id")
sample_source = pd.read_table(DATA_PATH.joinpath("run233/sample_source.txt"))
...
updates_layout = html.Div([
            dbc.Row([
                dbc.Row([
                    dbc.Col([
                        html.Br(),
                        html.H4("Summary of Run233", className='text-center'),
                        html.P([f"In Run 233, a total of ", html.B(total_samples), " samples from ",html.B("Kilifi"),\
                ...
                dbc.Row([
                    ...
                    dbc.Col([
                        ...
                        html.Br(),
                        html.P([html.B("XBB.1.22.1")," has not been reported before in Kenya. It was first detected in January 2023 \
                            in Bahrain. ",html.B("BQ.1.1")," has been detected in kenya since September 2022, and was last detected in January 2023"], style = style_text),
                    ],width=5,className = "h-100 bg-light"),

                ],justify="center",align="center",className = "mt-2"),
                
                dbc.Row([
                    html.P([f"Lineage classification was performed on ",html.B("April 28, 2023 "),"using", \
