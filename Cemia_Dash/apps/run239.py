...
fig_cov.update_layout(uniformtext_minsize=8,margin=margin) #,plot_bgcolor = pcolor,paper_bgcolor = pcolor
...
fig_var.update_layout(uniformtext_minsize=8,margin=margin,bargap=0.08)
...
fig_ct_cov.update_layout(margin=margin,plot_bgcolor = pcolor,paper_bgcolor = pcolor)
...
fig_bubble.update_layout(plot_bgcolor = pcolor,margin=margin,paper_bgcolor = pcolor,
                         legend=dict(itemsizing="constant",title = None,borderwidth=0,orientation = "h", font={"size":10},
                                     itemwidth=30, yanchor = "bottom",y = -0.8,xanchor = "left"))
            ...
            dbc.Row([
                dbc.Row([
                    dbc.Col([
                        ...
                        html.P([f"In {runid}, a total of ", html.B(total_samples), " samples from ",html.B("Kilifi, Nairobi(TNH) and Kiambu "),\
                            " were processed.",html.B(f" {samples_sequenced}"), html.B(f" ({round(samples_sequenced/total_samples*100)}%)") ,\
                                ...
                                'The predominant lineage was ', html.B("XBB.1.16 (30%)")],
                ...
                dbc.Row([
                    ...
                    dbc.Col([
                        ...
                        dag.AgGrid(
                            columnDefs=[{'field':'Facility'},
                                        {'field':'date_collect'},
                                        {'field':'samples'},
                                        {'field':'sequenced',"resizable": True}],
                            rowData=sample_source.to_dict('records'),
                            columnSize= 'sizeToFit',#'responsiveSizeToFit',
                            defaultColDef={"resizable": True, "sortable": False, "filter": False, "minWidth": 10},
                    ...
                    ],width=5,className = "h-100 bg-light border-bottom"),
                ...
                dbc.Row([
                    ...
                    dbc.Col([ #fig_n_prop
                            ...
                            html.P([f"This run was dominated by the ", html.B("XBB.1.16 (30%) "),"followed by ", html.B("FY.4.1 (21%). "),\
                                'Only 2 cases of ',html.B("GE.1 "),'lineage were observed.',
                ...
                dbc.Row([
                    ...
                    dbc.Col([
                        html.Br(),
                        html.P("Variant Distribution in Kenya: January - May 2023",className = col_title),
                        dcc.Graph(figure = sars_lineages, responsive = True,style = {"height":"35vh"}), #"width":"32hw"
                        html.Br(),
                        
                    ],width=6,className = "h-100 bg-light",style = {"margin-left":"10px"}),
                ...
                dbc.Row([
                    html.P([f"Lineage classification was performed on ",html.B("June 13, 2023 "),"using", \
