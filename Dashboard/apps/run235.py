...
recent_lineages = recent_lineages.groupby(["date","pangolin_lineage"])[["pangolin_lineage"]].count().rename(columns = {"pangolin_lineage":"Frequency"}).reset_index()
...
updates_layout = html.Div([
            dbc.Row([
                dbc.Row([
                    dbc.Col([
                        html.Br(),
                        html.H4("Summary of Run235", className='text-center'),
                        html.P([f"In {runid}, a total of ", html.B(total_samples), " samples from ",html.B("Kilifi"),\
                ...
                dbc.Row([
                    ...
                    dbc.Col([
                        html.Br(),
                        html.P("Variant Distribution in Kenya: Jan - Apr 2023",className = col_title),
                ...
                dbc.Row([
                    html.P([f"Lineage classification was performed on ",html.B("May 11, 2023 "),"using", \
